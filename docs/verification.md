...
- `npm test`: 85/85 deterministic physics, session, feedback and snapshot tests passed.
...
- `node tests/multiplayer.mjs`: guarded local v4 multiplayer passed. An authoritative Difficult/3-player crew finished in 39.476s and an Easy/5-player crew finished in 20.539s.
